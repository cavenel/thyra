...
class DLLManager:
    ...
    def __new__(cls, data_directory: Optional[Path] = None, 
                force_reload: bool = False) -> 'DLLManager':
        """
    ...
    def _initialize(self, data_directory: Optional[Path] = None, 
    ...
    def _load_library(self, data_directory: Optional[Path] = None) -> None:
        ...
        try:
            ...
            logger.info(f"Successfully loaded Bruker SDK using system PATH: {library_name}")
            return
        except Exception as e:
