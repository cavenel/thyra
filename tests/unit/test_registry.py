...
from msiconvert.core.registry import (
    register_reader, register_converter, register_format_detector,
    get_reader_class, get_converter_class, detect_format,
    reader_registry, converter_registry, format_detectors
)
...
class TestRegistry:
    ...
    def test_register_converter(self):
        ...
        class TestConverter(BaseMSIConverter):
            def _create_data_structures(self): pass
            def _save_output(self, data_structures): pass
